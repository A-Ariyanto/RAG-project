...
- [ ] Wire the eval script into GitHub Actions CI (local embeddings need no key; judge calls need the `DEEPSEEK_API_KEY` secret — DeepSeek is paid, so this is a funded key)
